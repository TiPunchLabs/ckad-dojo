...
> **Total Score**: 110 points | **Passing Score**: ~66% (73 points)
...
| **CNCF Weight** | 20% |
| **Namespace** | ocean |
| **Files** | `./exam/course/15/q1/Dockerfile` |
...
| **CNCF Weight** | 20% |
| **Namespace** | trench |
| **Files** | `./exam/course/15/q8/kustomization.yaml` |
...
| **CNCF Weight** | 15% |
| **Namespace** | depths |
| **Files** | `./exam/course/15/q10/events.txt` |
