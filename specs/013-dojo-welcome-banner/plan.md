...
exams/
├── ckad-simulation1/
│   └── exam.conf        # Add DOJO_NAME="Dojo Seiryu", DOJO_EMOJI="🐉"
├── ckad-simulation2/
│   └── exam.conf        # Add DOJO_NAME="Dojo Suzaku", DOJO_EMOJI="🔥"
├── ckad-simulation3/
│   └── exam.conf        # Add DOJO_NAME="Dojo Byakko", DOJO_EMOJI="🐯"
└── ckad-simulation4/
    └── exam.conf        # Add DOJO_NAME="Dojo Genbu", DOJO_EMOJI="🐢"

scripts/
├── lib/
│   └── banner.sh        # NEW: Banner display functions
└── ckad-exam.sh         # Modify to call banner on terminal start
```
...
|---------|-----------|------------|----------|
| ckad-simulation1 | Dojo Seiryu | 🐉 | Dragon Azure (Est) |
| ckad-simulation2 | Dojo Suzaku | 🔥 | Phénix Vermillon (Sud) |
| ckad-simulation3 | Dojo Byakko | 🐯 | Tigre Blanc (Ouest) |
| ckad-simulation4 | Dojo Genbu | 🐢 | Tortue Noire (Nord) |
